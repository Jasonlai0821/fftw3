...
/* Generated by: ../../../genfft/gen_twidsq.native -fma -compact -variables 4 -pipeline-latency 4 -reload-twiddle -dif -n 3 -name q1_3 -include fftw/rdft_scalar/q.h */
...
static void q1_3(FFTW_REAL_TYPE *rio, FFTW_REAL_TYPE *iio, const FFTW_REAL_TYPE *W, stride rs, stride vs, INT mb, INT me, INT ms)
{
...
void fftw_codelet_q1_3 (planner *p) {
     fftw_kdft_difsq_register (p, q1_3, &desc);
}
#else

/* Generated by: ../../../genfft/gen_twidsq.native -compact -variables 4 -pipeline-latency 4 -reload-twiddle -dif -n 3 -name q1_3 -include fftw/rdft_scalar/q.h */

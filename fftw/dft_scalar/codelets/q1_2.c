...
/* Generated by: ../../../genfft/gen_twidsq.native -fma -compact -variables 4 -pipeline-latency 4 -reload-twiddle -dif -n 2 -name q1_2 -include fftw/rdft_scalar/q.h */
...
static void q1_2(FFTW_REAL_TYPE *rio, FFTW_REAL_TYPE *iio, const FFTW_REAL_TYPE *W, stride rs, stride vs, INT mb, INT me, INT ms)
{
     {
	  INT m;
...
void fftw_codelet_q1_2 (planner *p) {
     fftw_kdft_difsq_register (p, q1_2, &desc);
}
#else

/* Generated by: ../../../genfft/gen_twidsq.native -compact -variables 4 -pipeline-latency 4 -reload-twiddle -dif -n 2 -name q1_2 -include fftw/rdft_scalar/q.h */

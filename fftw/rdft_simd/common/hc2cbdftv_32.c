...
/* Generated by: ../../../genfft/gen_hc2cdft_c.native -fma -rdft_simd -compact -variables 4 -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 32 -dif -sign 1 -name hc2cbdftv_32 -include fftw/rdft_simd/hc2cbv.h */
...
static void hc2cbdftv_32(FFTW_REAL_TYPE *Rp, FFTW_REAL_TYPE *Ip, FFTW_REAL_TYPE *Rm, FFTW_REAL_TYPE *Im, const FFTW_REAL_TYPE *W, stride rs, INT mb, INT me, INT ms)
{
...
void XSIMD(codelet_hc2cbdftv_32) (planner *p) {
     fftw_khc2c_register (p, hc2cbdftv_32, &desc, HC2C_VIA_DFT);
}
#else

/* Generated by: ../../../genfft/gen_hc2cdft_c.native -rdft_simd -compact -variables 4 -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 32 -dif -sign 1 -name hc2cbdftv_32 -include fftw/rdft_simd/hc2cbv.h */

...
/* Generated by: ../../../genfft/gen_hc2cdft_c.native -fma -rdft_simd -compact -variables 4 -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 16 -dit -name hc2cfdftv_16 -include fftw/rdft_simd/hc2cfv.h */
...
static void hc2cfdftv_16(FFTW_REAL_TYPE *Rp, FFTW_REAL_TYPE *Ip, FFTW_REAL_TYPE *Rm, FFTW_REAL_TYPE *Im, const FFTW_REAL_TYPE *W, stride rs, INT mb, INT me, INT ms)
{
...
void XSIMD(codelet_hc2cfdftv_16) (planner *p) {
     fftw_khc2c_register (p, hc2cfdftv_16, &desc, HC2C_VIA_DFT);
}
#else

/* Generated by: ../../../genfft/gen_hc2cdft_c.native -rdft_simd -compact -variables 4 -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 16 -dit -name hc2cfdftv_16 -include fftw/rdft_simd/hc2cfv.h */

...
static int hc2cbv_okp(const FFTW_REAL_TYPE *Rp, const FFTW_REAL_TYPE *Ip, const FFTW_REAL_TYPE *Rm, const FFTW_REAL_TYPE *Im, 
...
static int hc2cfv_okp(const FFTW_REAL_TYPE *Rp, const FFTW_REAL_TYPE *Ip, const FFTW_REAL_TYPE *Rm, const FFTW_REAL_TYPE *Im, 
		      INT rs, INT mb, INT me, INT ms, 
		      const planner *plnr)
{
     return (1

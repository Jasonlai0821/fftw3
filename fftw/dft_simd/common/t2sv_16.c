...
/* Generated by: ../../../genfft/gen_twiddle.native -fma -rdft_simd -compact -variables 4 -pipeline-latency 8 -twiddle-log3 -precompute-twiddles -n 16 -name t2sv_16 -include fftw/rdft_simd/ts.h */
...
static void t2sv_16(FFTW_REAL_TYPE *ri, FFTW_REAL_TYPE *ii, const FFTW_REAL_TYPE *W, stride rs, INT mb, INT me, INT ms)
{
...
void XSIMD(codelet_t2sv_16) (planner *p) {
     fftw_kdft_dit_register (p, t2sv_16, &desc);
}
#else

/* Generated by: ../../../genfft/gen_twiddle.native -rdft_simd -compact -variables 4 -pipeline-latency 8 -twiddle-log3 -precompute-twiddles -n 16 -name t2sv_16 -include fftw/rdft_simd/ts.h */

...
/* Generated by: ../../../genfft/gen_notw.native -fma -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 8 -name n2sv_8 -with-ostride 1 -include fftw/rdft_simd/n2s.h -store-multiple 4 */
...
static void n2sv_8(const FFTW_REAL_TYPE *ri,const FFTW_REAL_TYPE *ii, FFTW_REAL_TYPE *ro, FFTW_REAL_TYPE *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
void XSIMD(codelet_n2sv_8) (planner *p) {
     fftw_kdft_register (p, n2sv_8, &desc);
}

#else

/* Generated by: ../../../genfft/gen_notw.native -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 8 -name n2sv_8 -with-ostride 1 -include fftw/rdft_simd/n2s.h -store-multiple 4 */

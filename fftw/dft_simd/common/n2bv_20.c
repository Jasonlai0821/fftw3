...
/* Generated by: ../../../genfft/gen_notw_c.native -fma -rdft_simd -compact -variables 4 -pipeline-latency 8 -sign 1 -n 20 -name n2bv_20 -with-ostride 2 -include fftw/rdft_simd/n2b.h -store-multiple 2 */
...
static void n2bv_20(const FFTW_REAL_TYPE *ri, const FFTW_REAL_TYPE *ii, FFTW_REAL_TYPE *ro, FFTW_REAL_TYPE *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
void XSIMD(codelet_n2bv_20) (planner *p) {
     fftw_kdft_register (p, n2bv_20, &desc);
}

#else

/* Generated by: ../../../genfft/gen_notw_c.native -rdft_simd -compact -variables 4 -pipeline-latency 8 -sign 1 -n 20 -name n2bv_20 -with-ostride 2 -include fftw/rdft_simd/n2b.h -store-multiple 2 */

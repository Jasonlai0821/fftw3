...
/* Generated by: ../../../genfft/gen_notw_c.native -fma -rdft_simd -compact -variables 4 -pipeline-latency 8 -sign 1 -n 3 -name n1bv_3 -include fftw/rdft_simd/n1b.h */
...
static void n1bv_3(const FFTW_REAL_TYPE *ri, const FFTW_REAL_TYPE *ii, FFTW_REAL_TYPE *ro, FFTW_REAL_TYPE *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
void XSIMD(codelet_n1bv_3) (planner *p) {
     fftw_kdft_register (p, n1bv_3, &desc);
}

#else

/* Generated by: ../../../genfft/gen_notw_c.native -rdft_simd -compact -variables 4 -pipeline-latency 8 -sign 1 -n 3 -name n1bv_3 -include fftw/rdft_simd/n1b.h */

...
/* Generated by: ../../../genfft/gen_notw_c.native -fma -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 4 -name n2fv_4 -with-ostride 2 -include fftw/rdft_simd/n2f.h -store-multiple 2 */
...
static void n2fv_4(const FFTW_REAL_TYPE *ri, const FFTW_REAL_TYPE *ii, FFTW_REAL_TYPE *ro, FFTW_REAL_TYPE *io, stride is, stride os, INT v, INT ivs, INT ovs)
{
     {
	  INT i;
...
void XSIMD(codelet_n2fv_4) (planner *p) {
     fftw_kdft_register (p, n2fv_4, &desc);
}

#else

/* Generated by: ../../../genfft/gen_notw_c.native -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 4 -name n2fv_4 -with-ostride 2 -include fftw/rdft_simd/n2f.h -store-multiple 2 */

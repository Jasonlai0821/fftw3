...
/* Generated by: ../../../genfft/gen_twiddle_c.native -fma -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 8 -name t2bv_8 -include fftw/rdft_simd/t2b.h -sign 1 */
...
static void t2bv_8(FFTW_REAL_TYPE *ri, FFTW_REAL_TYPE *ii, const FFTW_REAL_TYPE *W, stride rs, INT mb, INT me, INT ms)
{
...
void XSIMD(codelet_t2bv_8) (planner *p) {
     fftw_kdft_dit_register (p, t2bv_8, &desc);
}
#else

/* Generated by: ../../../genfft/gen_twiddle_c.native -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 8 -name t2bv_8 -include fftw/rdft_simd/t2b.h -sign 1 */

...
/* Generated by: ../../../genfft/gen_twiddle_c.native -fma -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 5 -name t1fuv_5 -include fftw/rdft_simd/t1fu.h */
...
static void t1fuv_5(FFTW_REAL_TYPE *ri, FFTW_REAL_TYPE *ii, const FFTW_REAL_TYPE *W, stride rs, INT mb, INT me, INT ms)
{
...
void XSIMD(codelet_t1fuv_5) (planner *p) {
     fftw_kdft_dit_register (p, t1fuv_5, &desc);
}
#else

/* Generated by: ../../../genfft/gen_twiddle_c.native -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 5 -name t1fuv_5 -include fftw/rdft_simd/t1fu.h */

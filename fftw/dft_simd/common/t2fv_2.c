...
/* Generated by: ../../../genfft/gen_twiddle_c.native -fma -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 2 -name t2fv_2 -include fftw/rdft_simd/t2f.h */
...
static void t2fv_2(FFTW_REAL_TYPE *ri, FFTW_REAL_TYPE *ii, const FFTW_REAL_TYPE *W, stride rs, INT mb, INT me, INT ms)
{
     {
	  INT m;
	  FFTW_REAL_TYPE *x;
...
void XSIMD(codelet_t2fv_2) (planner *p) {
     fftw_kdft_dit_register (p, t2fv_2, &desc);
}
#else

/* Generated by: ../../../genfft/gen_twiddle_c.native -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 2 -name t2fv_2 -include fftw/rdft_simd/t2f.h */

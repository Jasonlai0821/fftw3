...
/* Generated by: ../../../genfft/gen_twidsq_c.native -fma -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 4 -dif -name q1bv_4 -include fftw/rdft_simd/q1b.h -sign 1 */
...
static void q1bv_4(FFTW_REAL_TYPE *ri, FFTW_REAL_TYPE *ii, const FFTW_REAL_TYPE *W, stride rs, stride vs, INT mb, INT me, INT ms)
{
     {
	  INT m;
	  FFTW_REAL_TYPE *x;
...
void XSIMD(codelet_q1bv_4) (planner *p) {
     fftw_kdft_difsq_register (p, q1bv_4, &desc);
}
#else

/* Generated by: ../../../genfft/gen_twidsq_c.native -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 4 -dif -name q1bv_4 -include fftw/rdft_simd/q1b.h -sign 1 */

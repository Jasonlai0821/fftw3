...
/* Generated by: ../../../genfft/gen_twiddle_c.native -fma -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 7 -name t1fuv_7 -include fftw/rdft_simd/t1fu.h */
...
static void t1fuv_7(FFTW_REAL_TYPE *ri, FFTW_REAL_TYPE *ii, const FFTW_REAL_TYPE *W, stride rs, INT mb, INT me, INT ms)
{
...
void XSIMD(codelet_t1fuv_7) (planner *p) {
     fftw_kdft_dit_register (p, t1fuv_7, &desc);
}
#else

/* Generated by: ../../../genfft/gen_twiddle_c.native -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 7 -name t1fuv_7 -include fftw/rdft_simd/t1fu.h */

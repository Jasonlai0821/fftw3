...
/* Generated by: ../../../genfft/gen_twiddle_c.native -fma -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 4 -name t2bv_4 -include fftw/rdft_simd/t2b.h -sign 1 */
...
static void t2bv_4(FFTW_REAL_TYPE *ri, FFTW_REAL_TYPE *ii, const FFTW_REAL_TYPE *W, stride rs, INT mb, INT me, INT ms)
{
     {
	  INT m;
	  FFTW_REAL_TYPE *x;
...
void XSIMD(codelet_t2bv_4) (planner *p) {
     fftw_kdft_dit_register (p, t2bv_4, &desc);
}
#else

/* Generated by: ../../../genfft/gen_twiddle_c.native -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 4 -name t2bv_4 -include fftw/rdft_simd/t2b.h -sign 1 */

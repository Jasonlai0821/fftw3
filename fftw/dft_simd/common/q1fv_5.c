...
/* Generated by: ../../../genfft/gen_twidsq_c.native -fma -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 5 -dif -name q1fv_5 -include fftw/rdft_simd/q1f.h */
...
static void q1fv_5(FFTW_REAL_TYPE *ri, FFTW_REAL_TYPE *ii, const FFTW_REAL_TYPE *W, stride rs, stride vs, INT mb, INT me, INT ms)
{
...
void XSIMD(codelet_q1fv_5) (planner *p) {
     fftw_kdft_difsq_register (p, q1fv_5, &desc);
}
#else

/* Generated by: ../../../genfft/gen_twidsq_c.native -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 5 -dif -name q1fv_5 -include fftw/rdft_simd/q1f.h */

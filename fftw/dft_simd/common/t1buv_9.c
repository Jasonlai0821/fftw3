...
/* Generated by: ../../../genfft/gen_twiddle_c.native -fma -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 9 -name t1buv_9 -include fftw/rdft_simd/t1bu.h -sign 1 */
...
static void t1buv_9(FFTW_REAL_TYPE *ri, FFTW_REAL_TYPE *ii, const FFTW_REAL_TYPE *W, stride rs, INT mb, INT me, INT ms)
{
...
void XSIMD(codelet_t1buv_9) (planner *p) {
     fftw_kdft_dit_register (p, t1buv_9, &desc);
}
#else

/* Generated by: ../../../genfft/gen_twiddle_c.native -rdft_simd -compact -variables 4 -pipeline-latency 8 -n 9 -name t1buv_9 -include fftw/rdft_simd/t1bu.h -sign 1 */

...
/* Generated by: ../../../genfft/gen_r2cf.native -fma -compact -variables 4 -pipeline-latency 4 -n 7 -name r2cf_7 -include fftw/rdft_scalar/r2cf.h */
...
static void r2cf_7(FFTW_REAL_TYPE *R0, FFTW_REAL_TYPE *R1, FFTW_REAL_TYPE *Cr, FFTW_REAL_TYPE *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
void fftw_codelet_r2cf_7 (planner *p) {
     fftw_kr2c_register (p, r2cf_7, &desc);
}

#else

/* Generated by: ../../../genfft/gen_r2cf.native -compact -variables 4 -pipeline-latency 4 -n 7 -name r2cf_7 -include fftw/rdft_scalar/r2cf.h */

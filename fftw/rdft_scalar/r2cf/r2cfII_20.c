...
/* Generated by: ../../../genfft/gen_r2cf.native -fma -compact -variables 4 -pipeline-latency 4 -n 20 -name r2cfII_20 -dft-II -include fftw/rdft_scalar/r2cfII.h */
...
static void r2cfII_20(FFTW_REAL_TYPE *R0, FFTW_REAL_TYPE *R1, FFTW_REAL_TYPE *Cr, FFTW_REAL_TYPE *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
void fftw_codelet_r2cfII_20 (planner *p) {
     fftw_kr2c_register (p, r2cfII_20, &desc);
}

#else

/* Generated by: ../../../genfft/gen_r2cf.native -compact -variables 4 -pipeline-latency 4 -n 20 -name r2cfII_20 -dft-II -include fftw/rdft_scalar/r2cfII.h */

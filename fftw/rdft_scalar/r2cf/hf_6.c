...
/* Generated by: ../../../genfft/gen_hc2hc.native -fma -compact -variables 4 -pipeline-latency 4 -n 6 -dit -name hf_6 -include fftw/rdft_scalar/hf.h */
...
static void hf_6(FFTW_REAL_TYPE *cr, FFTW_REAL_TYPE *ci, const FFTW_REAL_TYPE *W, stride rs, INT mb, INT me, INT ms)
{
...
void fftw_codelet_hf_6 (planner *p) {
     fftw_khc2hc_register (p, hf_6, &desc);
}
#else

/* Generated by: ../../../genfft/gen_hc2hc.native -compact -variables 4 -pipeline-latency 4 -n 6 -dit -name hf_6 -include fftw/rdft_scalar/hf.h */

...
/* Generated by: ../../../genfft/gen_r2r.native -fma -compact -variables 4 -pipeline-latency 4 -redft10 -n 8 -name e10_8 -include fftw/rdft_scalar/r2r.h */
...
static void e10_8(const FFTW_REAL_TYPE *I, FFTW_REAL_TYPE *O, stride is, stride os, INT v, INT ivs, INT ovs)
{
...
void fftw_codelet_e10_8 (planner *p) {
     fftw_kr2r_register (p, e10_8, &desc);
}

#else

/* Generated by: ../../../genfft/gen_r2r.native -compact -variables 4 -pipeline-latency 4 -redft10 -n 8 -name e10_8 -include fftw/rdft_scalar/r2r.h */

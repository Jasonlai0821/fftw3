...
/* Generated by: ../../../genfft/gen_hc2hc.native -fma -compact -variables 4 -pipeline-latency 4 -sign 1 -n 7 -dif -name hb_7 -include fftw/rdft_scalar/hb.h */
...
static void hb_7(FFTW_REAL_TYPE *cr, FFTW_REAL_TYPE *ci, const FFTW_REAL_TYPE *W, stride rs, INT mb, INT me, INT ms)
{
...
void fftw_codelet_hb_7 (planner *p) {
     fftw_khc2hc_register (p, hb_7, &desc);
}
#else

/* Generated by: ../../../genfft/gen_hc2hc.native -compact -variables 4 -pipeline-latency 4 -sign 1 -n 7 -dif -name hb_7 -include fftw/rdft_scalar/hb.h */

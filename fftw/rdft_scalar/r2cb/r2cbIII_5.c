...
/* Generated by: ../../../genfft/gen_r2cb.native -fma -compact -variables 4 -pipeline-latency 4 -sign 1 -n 5 -name r2cbIII_5 -dft-III -include fftw/rdft_scalar/r2cbIII.h */
...
static void r2cbIII_5(FFTW_REAL_TYPE *R0, FFTW_REAL_TYPE *R1, FFTW_REAL_TYPE *Cr, FFTW_REAL_TYPE *Ci, stride rs, stride csr, stride csi, INT v, INT ivs, INT ovs)
{
...
void fftw_codelet_r2cbIII_5 (planner *p) {
     fftw_kr2c_register (p, r2cbIII_5, &desc);
}

#else

/* Generated by: ../../../genfft/gen_r2cb.native -compact -variables 4 -pipeline-latency 4 -sign 1 -n 5 -name r2cbIII_5 -dft-III -include fftw/rdft_scalar/r2cbIII.h */

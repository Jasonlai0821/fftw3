...
static inline V LDK(FFTW_REAL_TYPE f) { return vec_splats(f); }

#define DVK(var, val) const FFTW_REAL_TYPE var = K(val)

static inline V VCONJ(V x)
{
  const V pmpm = vec_mergel(vec_splats((FFTW_REAL_TYPE)0.0),-(vec_splats((FFTW_REAL_TYPE)0.0)));
...
static inline void STA(FFTW_REAL_TYPE *x, V v, INT ovs, const FFTW_REAL_TYPE *aligned_like)
{
#ifdef __ibmxl__
  vec_xst(v,0,x);
#else
...
static inline void ST(FFTW_REAL_TYPE *x, V v, INT ovs, const FFTW_REAL_TYPE *aligned_like)
{
...
static inline void STM4(FFTW_REAL_TYPE *x, V v, INT ovs, const FFTW_REAL_TYPE *aligned_like)
{

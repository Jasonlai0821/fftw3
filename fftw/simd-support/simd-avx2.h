 ...
 *
 * Modifications by Romain Dolbeau & Erik Lindahl, derived from rdft_simd-avx.h
...
#error "compiling rdft_simd-avx2.h without avx2 support"
#endif
...
#else
static inline __m128d VMOVAPD_LD(const FFTW_REAL_TYPE *x)
{

...
#  error "compiling rdft_simd-sse2.h in double precision without -msse2"
#elif defined(__GNUC__) && defined(FFTW_SINGLE) && !defined(__SSE__)
#  error "compiling rdft_simd-sse2.h in single precision without -msse"
#endif

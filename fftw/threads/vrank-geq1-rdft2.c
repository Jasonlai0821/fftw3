...
static void apply(const plan *ego_, FFTW_REAL_TYPE *r0, FFTW_REAL_TYPE *r1, FFTW_REAL_TYPE *cr, FFTW_REAL_TYPE *ci)
{
...
static plan *mkplan(const solver *ego_, const problem *p_, planner *plnr)
{
     ...
     static const plan_adt padt = {
	  fftw_rdft2_solve, awake, print, destroy
     };
     ...
     fftw_rdft2_strides(p->kind, d, &its, &ots);
     ...
     for (i = 0; i < nthr; ++i) {
	  ...
	  cldp = fftw_mkproblem_rdft2(p->sz, vecsz,

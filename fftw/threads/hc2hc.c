...
static void apply_dit(const plan *ego_, FFTW_REAL_TYPE *I, FFTW_REAL_TYPE *O)
{
...
static void apply_dif(const plan *ego_, FFTW_REAL_TYPE *I, FFTW_REAL_TYPE *O)
{
     const P *ego = (const P *) ego_;
     plan_rdft *cld;
...
static plan *mkplan(const solver *ego_, const problem *p_, planner *plnr)
{
     ...
     if (plnr->nthr <= 1 || !fftw_hc2hc_applicable(ego, p_, plnr))
          return (plan *) 0;
...
hc2hc_solver *fftw_mksolver_hc2hc_threads(size_t size, INT r,

...
typedef struct {
     dotens2_closure k;
     FFTW_REAL_TYPE *ra; FFTW_REAL_TYPE *ia;
     FFTW_REAL_TYPE *rb; FFTW_REAL_TYPE *ib;
     int scalea, scaleb;
} cpy_closure;
...
static void cpy(FFTW_REAL_TYPE *ra, FFTW_REAL_TYPE *ia, const bench_tensor *sza, int scalea,
		FFTW_REAL_TYPE *rb, FFTW_REAL_TYPE *ib, const bench_tensor *szb, int scaleb)
{
     cpy_closure k;
     k.k.apply = cpy0;

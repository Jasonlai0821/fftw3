...
FFTW_EXTERN fftw_plan XM(plan_many_transpose_f03)(ptrdiff_t n0, ptrdiff_t n1, ptrdiff_t howmany, ptrdiff_t block0, ptrdiff_t block1, R * in, R * out, MPI_Fint f_comm, unsigned flags);
FFTW_EXTERN fftw_plan XM(plan_transpose_f03)(ptrdiff_t n0, ptrdiff_t n1, R * in, R * out, MPI_Fint f_comm, unsigned flags);
...
FFTW_EXTERN fftw_plan XM(plan_many_r2r_f03)(int rnk, const ptrdiff_t * n, ptrdiff_t howmany, ptrdiff_t iblock, ptrdiff_t oblock, R * in, R * out, MPI_Fint f_comm, const fftw_r2r_kind * kind, unsigned flags);
FFTW_EXTERN fftw_plan XM(plan_r2r_f03)(int rnk, const ptrdiff_t * n, R * in, R * out, MPI_Fint f_comm, const fftw_r2r_kind * kind, unsigned flags);
FFTW_EXTERN fftw_plan XM(plan_r2r_2d_f03)(ptrdiff_t n0, ptrdiff_t n1, R * in, R * out, MPI_Fint f_comm, fftw_r2r_kind kind0, fftw_r2r_kind kind1, unsigned flags);
FFTW_EXTERN fftw_plan XM(plan_r2r_3d_f03)(ptrdiff_t n0, ptrdiff_t n1, ptrdiff_t n2, R * in, R * out, MPI_Fint f_comm, fftw_r2r_kind kind0, fftw_r2r_kind kind1, fftw_r2r_kind kind2, unsigned flags);
FFTW_EXTERN fftw_plan XM(plan_many_dft_r2c_f03)(int rnk, const ptrdiff_t * n, ptrdiff_t howmany, ptrdiff_t iblock, ptrdiff_t oblock, R * in, fftw_complex * out, MPI_Fint f_comm, unsigned flags);
FFTW_EXTERN fftw_plan XM(plan_dft_r2c_f03)(int rnk, const ptrdiff_t * n, R * in, fftw_complex * out, MPI_Fint f_comm, unsigned flags);
FFTW_EXTERN fftw_plan XM(plan_dft_r2c_2d_f03)(ptrdiff_t n0, ptrdiff_t n1, R * in, fftw_complex * out, MPI_Fint f_comm, unsigned flags);
FFTW_EXTERN fftw_plan XM(plan_dft_r2c_3d_f03)(ptrdiff_t n0, ptrdiff_t n1, ptrdiff_t n2, R * in, fftw_complex * out, MPI_Fint f_comm, unsigned flags);
FFTW_EXTERN fftw_plan XM(plan_many_dft_c2r_f03)(int rnk, const ptrdiff_t * n, ptrdiff_t howmany, ptrdiff_t iblock, ptrdiff_t oblock, fftw_complex * in, R * out, MPI_Fint f_comm, unsigned flags);
FFTW_EXTERN fftw_plan XM(plan_dft_c2r_f03)(int rnk, const ptrdiff_t * n, fftw_complex * in, R * out, MPI_Fint f_comm, unsigned flags);
FFTW_EXTERN fftw_plan XM(plan_dft_c2r_2d_f03)(ptrdiff_t n0, ptrdiff_t n1, fftw_complex * in, R * out, MPI_Fint f_comm, unsigned flags);
FFTW_EXTERN fftw_plan XM(plan_dft_c2r_3d_f03)(ptrdiff_t n0, ptrdiff_t n1, ptrdiff_t n2, fftw_complex * in, R * out, MPI_Fint f_comm, unsigned flags);
...
X(plan) XM(plan_many_dft_f03)(int rnk, const ptrdiff_t * n, ptrdiff_t howmany, ptrdiff_t block, ptrdiff_t tblock, fftw_complex * in, fftw_complex * out, MPI_Fint f_comm, int sign, unsigned flags)
{
     MPI_Comm comm;
...
X(plan) XM(plan_dft_f03)(int rnk, const ptrdiff_t * n, fftw_complex * in, fftw_complex * out, MPI_Fint f_comm, int sign, unsigned flags)
{
     MPI_Comm comm;
...
X(plan) XM(plan_dft_1d_f03)(ptrdiff_t n0, fftw_complex * in, fftw_complex * out, MPI_Fint f_comm, int sign, unsigned flags)
{
     MPI_Comm comm;
...
X(plan) XM(plan_dft_2d_f03)(ptrdiff_t n0, ptrdiff_t n1, fftw_complex * in, fftw_complex * out, MPI_Fint f_comm, int sign, unsigned flags)
{
     MPI_Comm comm;
...
X(plan) XM(plan_dft_3d_f03)(ptrdiff_t n0, ptrdiff_t n1, ptrdiff_t n2, fftw_complex * in, fftw_complex * out, MPI_Fint f_comm, int sign, unsigned flags)
{
     MPI_Comm comm;
...
X(plan) XM(plan_many_r2r_f03)(int rnk, const ptrdiff_t * n, ptrdiff_t howmany, ptrdiff_t iblock, ptrdiff_t oblock, R * in, R * out, MPI_Fint f_comm, const fftw_r2r_kind * kind, unsigned flags)
{
     MPI_Comm comm;
...
X(plan) XM(plan_r2r_f03)(int rnk, const ptrdiff_t * n, R * in, R * out, MPI_Fint f_comm, const fftw_r2r_kind * kind, unsigned flags)
{
     MPI_Comm comm;
...
X(plan) XM(plan_r2r_2d_f03)(ptrdiff_t n0, ptrdiff_t n1, R * in, R * out, MPI_Fint f_comm, fftw_r2r_kind kind0, fftw_r2r_kind kind1, unsigned flags)
{
     MPI_Comm comm;
...
X(plan) XM(plan_r2r_3d_f03)(ptrdiff_t n0, ptrdiff_t n1, ptrdiff_t n2, R * in, R * out, MPI_Fint f_comm, fftw_r2r_kind kind0, fftw_r2r_kind kind1, fftw_r2r_kind kind2, unsigned flags)
{
     MPI_Comm comm;
...
X(plan) XM(plan_many_dft_r2c_f03)(int rnk, const ptrdiff_t * n, ptrdiff_t howmany, ptrdiff_t iblock, ptrdiff_t oblock, R * in, fftw_complex * out, MPI_Fint f_comm, unsigned flags)
{
     MPI_Comm comm;
...
X(plan) XM(plan_dft_r2c_f03)(int rnk, const ptrdiff_t * n, R * in, fftw_complex * out, MPI_Fint f_comm, unsigned flags)
{
     MPI_Comm comm;
...
X(plan) XM(plan_dft_r2c_2d_f03)(ptrdiff_t n0, ptrdiff_t n1, R * in, fftw_complex * out, MPI_Fint f_comm, unsigned flags)
{
     MPI_Comm comm;
...
X(plan) XM(plan_dft_r2c_3d_f03)(ptrdiff_t n0, ptrdiff_t n1, ptrdiff_t n2, R * in, fftw_complex * out, MPI_Fint f_comm, unsigned flags)
{
     MPI_Comm comm;
...
X(plan) XM(plan_many_dft_c2r_f03)(int rnk, const ptrdiff_t * n, ptrdiff_t howmany, ptrdiff_t iblock, ptrdiff_t oblock, fftw_complex * in, R * out, MPI_Fint f_comm, unsigned flags)
{
     MPI_Comm comm;
...
X(plan) XM(plan_dft_c2r_f03)(int rnk, const ptrdiff_t * n, fftw_complex * in, R * out, MPI_Fint f_comm, unsigned flags)
{
     MPI_Comm comm;
...
X(plan) XM(plan_dft_c2r_2d_f03)(ptrdiff_t n0, ptrdiff_t n1, fftw_complex * in, R * out, MPI_Fint f_comm, unsigned flags)
{
     MPI_Comm comm;
...
X(plan) XM(plan_dft_c2r_3d_f03)(ptrdiff_t n0, ptrdiff_t n1, ptrdiff_t n2, fftw_complex * in, R * out, MPI_Fint f_comm, unsigned flags)
{
     MPI_Comm comm;
